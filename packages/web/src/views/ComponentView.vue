...
const categories: ComponentCategory[] = [
    ...
    components: [
      {
        id: "buttons",
        name: "Buttons",
        description: "Primary, outline, and icon buttons",
      },
      {
        id: "badges",
        name: "Badges",
  ...
  },
  {
    ...
    components: [
      ...
      {
        id: "attribution-card",
        name: "Attribution Card",
        description: "Image attribution card",
      },
      {
        id: "portfolio-item",
        name: "Portfolio Item",
  ...
  },
  {
    ...
    components: [
      ...
      },
      {
        id: "icon-flow-step",
        name: "IconFlowStep",
        description: "Icon box for process flows",
      },
    ],
  },
  {
    ...
    components: [
      {
        id: "system-box",
        name: "System Box",
        description: "System representation box",
      },
      {
        id: "entity-mapping",
        ...
        >
          ...
          <div v-if="selectedComponentId === 'buttons'" class="space-y-8">
            ...
            <div>
              ...
              <p class="text-sm text-gray-400 mb-4">
                Primary button as router-link (use for navigation - avoids
                double-tab)
              </p>
              <div class="flex flex-wrap gap-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-400 mb-4">
                Outline button as router-link (use for navigation - avoids
                double-tab)
              </p>
              <div class="flex flex-wrap gap-4">
          ...
          <div v-if="selectedComponentId === 'panels'">
            <div class="space-y-4">
              <p class="text-gray-400">
                Panel components (PanelContent, PanelSidebar) are used in views
                for layout and are not showcased individually.
              </p>
              <p class="text-gray-400">
                <strong class="text-white">This page uses them!</strong> The
                left sidebar is PanelSidebar and this content area is
                PanelContent (which works on both mobile and desktop).
              </p>
            </div>
          </div>
          ...
          <div
            v-if="selectedComponentId === 'service-section'"
            class="space-y-8"
          >
            <div>
          ...
          <div v-if="selectedComponentId === 'cta-form'" class="space-y-6">
            ...
            <div>
              <h3 class="text-xl font-bold mb-4 text-white">
                Dark Variant with Service Selector
              </h3>
              <CTAForm
                variant="dark"
