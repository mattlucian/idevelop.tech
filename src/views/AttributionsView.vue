    ...
    <div class="w-full max-w-[1200px] mx-auto px-6 py-12">
      ...
      <div class="mb-12">
        ...
        <p class="text-lg text-gray-400 max-w-3xl">
          We use beautiful images from talented photographers on Unsplash. All images are used under
          the
          <a
      ...
      <!-- Services Section -->
      <section class="mb-12">
        <h2 class="text-2xl sm:text-3xl font-bold mb-6 text-teal-400">Service Images</h2>
