...
<template>
  <div class="min-h-screen bg-[#0a0a0a] pt-16">
    ...
    >
      <CTAForm service-name="Integration" form-title="Request Information" variant="dark" />
    </ServiceSection>
      ...
      >
        ...
        <div v-if="activeTab === 'accounting'">
          <IntegrationDiagram
            ...
            :mapping-color-scheme="integrationDiagrams.accounting.mappingColorScheme"
          />
        </div>
        ...
        <div v-if="activeTab === 'fulfillment'">
          <IntegrationDiagram
            ...
            :mapping-color-scheme="integrationDiagrams.fulfillment.mappingColorScheme"
          />
        </div>
        ...
        <div v-if="activeTab === 'marketplace'">
          <IntegrationDiagram
            ...
            :mapping-color-scheme="integrationDiagrams.marketplace.mappingColorScheme"
          />
        </div>
      </div>
    </div>
