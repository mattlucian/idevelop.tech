...
useMeta({
  ...
  description:
    'Automate your eCommerce operations with expert order routing, inventory sync, and product data management. Connect Shopify, 3PLs, and marketplaces for seamless multi-channel selling.',
  ogTitle: 'eCommerce Operations & Automation Services | I Develop Tech',
  ogDescription:
    'Eliminate manual eCommerce operations. Automated order routing, real-time inventory sync, and product data management across all your sales channels.',
      ...
      >
        ...
        <div v-if="activeTab === 'order-routing'">
          ...
          <div class="mb-8">
            <div class="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 mb-6">
              <template
                v-for="(step, index) in tabContent['order-routing'].visual.steps"
                :key="index"
              >
                <IconFlowStep
                  :emoji="step.emoji"
                ...
                />
                <div
                  v-if="index < tabContent['order-routing'].visual.steps.length - 1"
          ...
          <div class="space-y-3">
            ...
            >
              ...
              <p class="text-gray-300 text-sm md:text-base">{{ benefit }}</p>
            </div>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'inventory-sync'">
          ...
          <div class="grid md:grid-cols-2 gap-6 mb-8">
            <div class="bg-red-500/10 border border-red-500/30 rounded-lg p-6">
              ...
              <ul class="space-y-2">
                <li
                  v-for="(item, index) in tabContent['inventory-sync'].beforeAfter.before.items"
                  :key="index"
            ...
            <div class="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-6">
              <h4 class="font-semibold text-emerald-400 mb-4 text-base md:text-lg">
                {{ tabContent['inventory-sync'].beforeAfter.after.title }}
              </h4>
              <ul class="space-y-2">
                <li
                  v-for="(item, index) in tabContent['inventory-sync'].beforeAfter.after.items"
                  :key="index"
                  class="flex items-start gap-2 text-gray-300 text-sm md:text-base"
                >
        ...
        <div v-if="activeTab === 'product-data'">
          ...
          <div class="grid md:grid-cols-2 gap-4 mb-8">
            <div
              v-for="(stage, index) in tabContent['product-data'].workflow.stages"
              :key="index"
            ...
            >
              <div class="flex items-center gap-2 mb-3">
                ...
                <h4 class="font-semibold text-white text-base md:text-lg">{{ stage.stage }}</h4>
              </div>
