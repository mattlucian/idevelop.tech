...
<template>
  <div class="min-h-screen bg-[#0a0a0a] pt-16">
    ...
    >
      <CTAForm service-name="Tech Admin" form-title="Request Information" variant="dark" />
    </ServiceSection>
    ...
    <div class="max-w-5xl mx-auto px-6 py-6">
      ...
      >
        ...
        <div v-if="activeTab === 'planning'" class="space-y-6">
          <div>
            <h3 class="text-2xl font-bold text-white mb-4">Strategic Planning</h3>
            <p class="text-gray-300 mb-6 leading-relaxed">
              Get clarity on your technology landscape with comprehensive stack documentation and
              actionable roadmaps.
            </p>
          </div>
          ...
          <div class="mt-8 p-6 bg-slate-800/40 rounded-lg border border-slate-700/30">
            <h4 class="text-lg font-semibold text-cyan-400 mb-3">Deliverables</h4>
        ...
        <div v-if="activeTab === 'execution'" class="space-y-6">
          <div>
            <h3 class="text-2xl font-bold text-white mb-4">Technical Execution</h3>
            <p class="text-gray-300 mb-6 leading-relaxed">
              Not just advice - I roll up my sleeves and build the solutions your business needs.
            </p>
          </div>

          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="p-6 bg-slate-800/40 rounded-lg border border-slate-700/30">
              <div class="text-3xl mb-3">⚙️</div>
              <h4 class="text-lg font-semibold text-white mb-2">Automation Workflows</h4>
              <p class="text-gray-400 text-sm">
                Streamline operations by building custom automation that eliminates manual work and
                reduces errors.
              </p>
            </div>
            ...
            <div class="p-6 bg-slate-800/40 rounded-lg border border-slate-700/30">
              ...
              <h4 class="text-lg font-semibold text-white mb-2">Integrations & Migrations</h4>
              <p class="text-gray-400 text-sm">
                Connect your systems and handle complex migrations with minimal downtime and clear
                documentation.
              </p>
            </div>
            ...
            <div class="p-6 bg-slate-800/40 rounded-lg border border-slate-700/30">
              <div class="text-3xl mb-3">🚀</div>
              <h4 class="text-lg font-semibold text-white mb-2">Operational Support</h4>
              <p class="text-gray-400 text-sm">
                Sales prep, system configurations, troubleshooting - the hands-on work that keeps
            ...
            <div class="p-6 bg-slate-800/40 rounded-lg border border-slate-700/30">
              <div class="text-3xl mb-3">🔧</div>
              <h4 class="text-lg font-semibold text-white mb-2">Maintain & Optimize</h4>
              <p class="text-gray-400 text-sm">
                Proactive system maintenance, performance optimization, and continuous improvements
                based on usage patterns.
              </p>
            </div>
          </div>

          <div class="mt-6 p-6 bg-cyan-500/10 rounded-lg border border-cyan-500/20">
            <p class="text-cyan-300 font-semibold mb-2">Real Expertise</p>
            <p class="text-gray-300 text-sm">
              10+ years full-stack development • 7+ years AWS cloud architecture • 6+ years CI/CD &
              DevOps automation • 100+ integrations & data pipelines
            </p>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'support'" class="space-y-6">
          <div>
            <h3 class="text-2xl font-bold text-white mb-4">Ongoing Support & Optimization</h3>
            <p class="text-gray-300 mb-6 leading-relaxed">
              Proactive maintenance and continuous improvement with flexible hour allocation based
              on your needs.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 class="text-lg font-semibold text-cyan-400 mb-4">Regular Activities</h4>
            ...
            <div>
              <h4 class="text-lg font-semibold text-purple-400 mb-4">Optimization Focus</h4>
              <ul class="space-y-3 text-gray-300">
                <li class="flex items-start">
                  <span class="text-purple-400 mr-2 mt-1">→</span>
                  <span>Identify cost savings opportunities (quarterly review)</span>
                </li>
                <li class="flex items-start">
                  <span class="text-purple-400 mr-2 mt-1">→</span>
          ...
          <div class="mt-6 p-6 bg-slate-800/60 rounded-lg border border-slate-700/30">
            <h4 class="text-base font-semibold text-white mb-3">Flexible Hour Allocation</h4>
            <div class="flex flex-col md:flex-row gap-4 text-sm">
              <div class="flex-1">
                <p class="text-cyan-400 font-semibold mb-1">10 hrs/month</p>
                <p class="text-gray-400">Steady maintenance and regular support</p>
              </div>
              <div class="flex-1">
                <p class="text-purple-400 font-semibold mb-1">20-30 hrs/month</p>
                <p class="text-gray-400">When pushing initiatives or handling burst projects</p>
              </div>
            </div>
          </div>
        </div>
