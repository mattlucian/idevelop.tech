...
<template>
  <div class="min-h-screen bg-[#0a0a0a] pt-16">
    ...
    >
      <CTAForm service-name="Web Design" form-title="Request Information" variant="dark" />
    </ServiceSection>
    ...
    <div class="max-w-5xl mx-auto px-6 py-6">
      ...
      >
        ...
        <div v-if="activeTab === 'design'">
          <h3 class="text-xl md:text-2xl font-semibold text-white mb-6 text-center">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <h4 class="text-lg font-semibold text-cyan-400 mb-2">{{ step.title }}</h4>
              <p class="text-sm text-gray-400">{{ step.description }}</p>
            </div>
          </div>
          <p class="text-center text-gray-400 mt-8 text-sm">
            Transparent, structured process with regular updates and staging site access
          </p>
        </div>
        ...
        <div v-if="activeTab === 'platforms'">
          ...
          <div class="space-y-6">
            <div
              ...
              class="bg-slate-800/50 rounded-lg p-6 border border-slate-700/30"
            >
              <h4 class="text-lg font-semibold text-cyan-400 mb-2">{{ platform.name }}</h4>
              <p class="text-sm text-gray-400 mb-4">{{ platform.description }}</p>
        ...
        <div v-if="activeTab === 'migration'">
          ...
          <div class="space-y-6">
            <div
              ...
              class="bg-slate-800/50 rounded-lg p-6 border border-slate-700/30"
            >
              <h4 class="text-lg font-semibold text-purple-400 mb-3">{{ phase.phase }}</h4>
          ...
          <p class="text-center text-gray-400 mt-6 text-sm">
            Complete migration checklist ensures zero downtime and preserved search rankings
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto px-6 py-12">
      ...
      <div class="grid md:grid-cols-2 gap-6">
        ...
        >
          <h3 class="text-xl font-semibold text-red-400 mb-4">❌ Generic Template</h3>
          <ul class="space-y-3">
        ...
        >
          <h3 class="text-xl font-semibold text-emerald-400 mb-4">✓ Custom Brand Experience</h3>
          <ul class="space-y-3">
            <li class="flex items-start text-gray-300 text-sm">
