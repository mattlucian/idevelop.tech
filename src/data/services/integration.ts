...
export const integrationServiceData: IntegrationServiceData = {
  // Navigation
  breadcrumbs: [{ label: 'Home', path: '/' }, { label: 'Integration Services' }],

  // Hero Section
  hero: {
    title: 'Connect Your Systems with Transparent, Fixed-Fee Integrations',
    subtitle:
      'Stop copying data between systems. Get custom API and file integrations with clear documentation, no surprise charges, and regular progress updates.',
    colorScheme: 'cyan',
  },
  ...
  integrationDiagrams: {
    accounting: {
      ...
      caption: 'Sync orders, products, and customers to your accounting platform',
    ...
    fulfillment: {
      ...
      caption: 'Keep inventory up-to-date and automate fulfillment & tracking flows',
    ...
    marketplace: {
      ...
      caption: 'Sync marketplace orders, update inventory levels, and provide tracking information',
  ...
  benefits: [
    {
      ...
      description:
        'Complete data mapping documentation with configuration options for self-service adjustments.',
    },
    {
      title: 'No Surprise Charges',
      description: 'Fixed-fee project pricing with regular updates. You know the cost upfront.',
    },
    {
      title: 'Tailored to Your Systems',
      description:
        'Custom-built integrations designed for your specific platforms and business workflows.',
    },
  ],
  ...
  howItWorks: [
    ...
    'Fixed-fee proposal (no overages or surprise charges)',
    'Regular progress updates every 1-2 days during development',
    ...
    items: [
      {
        ...
        description: 'Built an integration into Sage Intacct for eCommerce accounting purposes',
      },
      {
        name: 'Gordon Truck Centers',
        url: 'https://gordontruckcenters.com',
        logo: '/images/partners/gordontruckcenters_dark.png',
        description: 'Enterprise system integration for truck dealership operations',
      },
      {
        name: 'Flxpoint',
        url: 'https://flxpoint.com',
        logo: '/images/partners/flxpoint-logo-dark.png',
        description: 'Built multiple supplier integrations and marketplace connections',
      },
    ],
    testimonial: {
      quote:
  ...
  cta: {
    ...
    subtitle: "Let's discuss your integration needs and how I can help connect your systems.",
