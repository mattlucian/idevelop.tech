...
export const cloudConsultingServiceData: CloudConsultingServiceData = {
  // Navigation
  breadcrumbs: [{ label: 'Home', path: '/' }, { label: 'Cloud & Infrastructure Consulting' }],

  // Hero Section
  hero: {
    title: 'Navigate the Cloud with Expert AWS Guidance',
    subtitle:
      'Stop overpaying for cloud infrastructure. Get practical AWS consulting for cost optimization, migration planning, and architecture reviews without hiring a full-time cloud team.',
    colorScheme: 'cyan',
  },
  ...
  benefits: [
    ...
    {
      title: 'Minimal Disruption Migrations',
      description:
        'Cloud migration planning with clear rollback strategies, thorough testing, and comprehensive monitoring setup.',
    },
  ],
  ...
  howItWorks: [
    ...
    'Complete documentation and knowledge transfer for projects over 10 hours',
  ],
    ...
    items: [
      {
        ...
        description: 'AWS infrastructure supporting millions of daily eCommerce operations',
      },
      {
  ...
  cta: {
    ...
    subtitle:
      "Let's discuss your AWS needs and how I can help reduce costs, improve performance, and accelerate your cloud journey.",
      ...
      steps: [
        {
          icon: '🔍',
          label: 'Assess',
          description: 'Review current infrastructure, workload requirements, and cloud readiness',
        },
        {
          icon: '📋',
          label: 'Plan',
          description: 'Design cloud architecture, select services, and create migration roadmap',
        },
        {
          icon: '🚀',
          label: 'Deploy',
          description: 'Execute migration with minimal downtime and thorough testing',
        },
        {
          icon: '📈',
          label: 'Optimize',
          description: 'Monitor costs, right-size resources, and implement ongoing improvements',
        },
      ],
    },
    migration: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'Set up AWS infrastructure and validate application compatibility',
        },
        {
          icon: '🔄',
        ...
        },
        {
          icon: '✅',
          label: 'Validation',
          description: 'Performance testing, monitoring setup, and team training',
        },
      ],
    },
    optimization: {
      ...
      steps: [
        {
          icon: '🔎',
          label: 'Audit',
          description: 'Identify unused resources, oversized instances, and inefficient patterns',
        },
        {
          icon: '💡',
          label: 'Recommendations',
          description: 'Reserved Instances, Savings Plans, auto-scaling, and service alternatives',
        },
        {
          icon: '⚙️',
          label: 'Implementation',
          description: 'Apply optimizations with A/B testing to ensure performance',
        },
        {
          icon: '📉',
          label: 'Monitor',
          description: 'Continuous cost tracking, alerts, and monthly optimization reviews',
        },
      ],
    },
  },
