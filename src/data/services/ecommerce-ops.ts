...
export const ecommerceOpsServiceData: EcommerceOpsServiceData = {
  // Navigation
  breadcrumbs: [{ label: 'Home', path: '/' }, { label: 'eCommerce Operations' }],

  // Hero Section
  hero: {
    title: 'Scale Your eCommerce Operations',
    subtitle:
      'Stop juggling manual processes across multiple channels. Get distributed order routing, real-time inventory sync, and automated product data management across Shopify, Amazon, eBay, and beyond.',
    colorScheme: 'cyan',
  },
  ...
  benefits: [
    {
      ...
      description:
        'Seamless integrations across Shopify, WooCommerce, Amazon, eBay, and other marketplaces with automated data flows.',
    },
    {
      title: 'Eliminate Manual Work',
      description:
        'Stop copying data between systems. Automate order routing, inventory sync, and product updates to save hours every day.',
    },
    {
      title: 'Scale Without Headaches',
      description:
        'Technical solutions that grow with your business, handling high volumes across multiple warehouses and sales channels.',
    },
  ],

  expertiseBadge: {
    title: 'Proven eCommerce Automation',
    description:
      'Technical solutions that scale operations efficiently with product data management, shipping carrier integrations, and marketing tool connections.',
  },
  ...
  whatIOffer: [
    ...
    'Fixed-fee project pricing with comprehensive documentation and ongoing support options',
  ],

  howItWorks: [
    'Free consultation to understand your eCommerce challenges and automation needs',
    'Fixed-fee proposal based on estimated hours (no overages or surprise charges)',
    'Regular progress updates every 1-2 days throughout development',
    ...
    items: [
      {
        ...
        description: 'Built ecommerce automation processes to streamline operations',
      },
      {
      ...
      },
      {
        ...
        description: 'eCommerce automation for frame and picture album business',
      },
    ],
    testimonial: {
      quote:
  ...
  cta: {
    ...
    subtitle:
      "Let's discuss how I can help streamline your order routing, inventory sync, and product data management.",
  ...
  tabContent: {
    'order-routing': {
      ...
      benefits: [
        ...
        'Dropshipping automation with real-time supplier integration',
      ...
      visual: {
        ...
        steps: [
          { emoji: '🛍️', label: 'Customer Orders', desc: 'Order placed on your store' },
          { emoji: '🎯', label: 'Smart Routing', desc: 'Allocate to best location' },
          { emoji: '📦', label: 'Auto-Fulfillment', desc: 'Sent to optimal warehouse' },
          { emoji: '🚚', label: 'Fast Shipping', desc: 'Shortest delivery time' },
        ],
      },
    },
    'inventory-sync': {
      ...
      description:
        'Keep inventory accurate across all sales channels with automated stock level updates from multiple sources, preventing overselling and lost sales.',
      benefits: [
        'Real-time sync across Shopify, Amazon, eBay, and other marketplaces',
      ...
      beforeAfter: {
        ...
        after: {
          ...
          items: [
            ...
            'Maximized sales with accurate stock data',
          ],
        },
      },
    },
