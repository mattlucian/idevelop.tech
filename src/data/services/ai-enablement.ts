...
export const aiEnablementServiceData: AIEnablementServiceData = {
  ...
  hero: {
    ...
    subtitle:
      'Stop guessing where AI fits. Get hands-on training workshops with workflow analysis to identify high-impact opportunities. Focus on what works: documentation, testing, and code assistance.',
    colorScheme: 'cyan',
  },
  ...
  tabContent: {
    workflow: {
      title: "Transform Your Team's Workflows with AI",
      description:
      ...
      afterItems: [
        'Clear AI adoption strategy and roadmap',
        'Team knows exactly which tools to use',
        'Focused on high-impact applications',
        'AI integrated seamlessly into daily work',
      ],
    },
    training: {
  ...
  expertiseBadge: {
    ...
    description:
      'Focus on proven AI applications that work today, with training materials and follow-up support for sustainable adoption.',
  },
    ...
    items: [
      {
        ...
        description: 'Leveraged AI tools to assist with the creation of idevelop.tech website',
      },
    ],
    testimonial: {
      quote:
        'Matt showed us a lot of great tactics we can use to leverage AI and improve our developer operations; a total game-changer!',
      author: 'Developer',
  ...
  cta: {
    ...
    subtitle:
      "Let's discuss how hands-on AI training can transform your team's workflows and productivity.",
